...
int main(int argc, char *argv[]) {
    ...
    if (test & 4)
        kmeans_cgra(fpgaBinaryFile,kernel_name,idx, NUM_CLUSTERS, NUM_DIM);
...
int kmeans_cgra(std::string fpgaBinaryFile, std::string kernel_name,int idx, int num_clusters, int num_dim) {
